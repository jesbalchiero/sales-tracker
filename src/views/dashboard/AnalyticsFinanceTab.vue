...
const series = {
  renda: [{ data: [24, 21, 30, 22, 42, 26, 35, 29] }],
  despesas: [{ data: [24, 21, 30, 25, 42, 26, 35, 29] }],
  lucro: [{ data: [24, 21, 30, 22, 42, 26, 35, 35] }],
}

const currentTab = ref <keyof TabsData> ('renda')
  ...
  <VCard>
    ...
    <VCardText class="d-flex align-center justify-center gap-3">
      ...
      <div>
        ...
        <span class="text-sm text-disabled">{{ tabData.compareToLastWeek }} menos que na semana passada</span>
      </div>
    </VCardText>
  </VCard>
</template>
