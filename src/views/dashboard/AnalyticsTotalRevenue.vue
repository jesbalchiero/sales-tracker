...
const balanceData = [
  { icon: 'bx-dollar', amount: 'R$32.5k', year: '2023', color: 'primary' },
  { icon: 'bx-wallet', amount: 'R$41.2k', year: '2022', color: 'info' },
]
</script>
    ...
    <VRow no-gutters>
      ...
      >
        <VCardItem class="pb-0">
          <VCardTitle>Rendimento Total</VCardTitle>
        </VCardItem>
